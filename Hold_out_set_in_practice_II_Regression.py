...
# In this script, i will use GridSearchCV to tune the 'l1_ratio' of an elastic net model trained on the Gapminder data. 
...
# Specify the hyperparameter grid for 'l1_ratio',
# using l1_space as the grid of values to search over.
